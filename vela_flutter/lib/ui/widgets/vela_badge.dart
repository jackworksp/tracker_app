...
enum VelaBadgeVariant { defaultVariant, info, success, warning, error, brand, purple }
...
class VelaBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (double height, double fontSize, EdgeInsets padding) = switch (size) {
      VelaBadgeSize.sm => (20.0, 11.0, const EdgeInsets.symmetric(horizontal: 6, vertical: 2)),
      VelaBadgeSize.md => (24.0, 12.0, const EdgeInsets.symmetric(horizontal: 8, vertical: 4)),
      VelaBadgeSize.lg => (28.0, 13.0, const EdgeInsets.symmetric(horizontal: 10, vertical: 5)),
    };
    ...
    Widget badge = Container(
      ...
      child: Row(
        ...
        children: [
          DefaultTextStyle(
            style: TextStyle(color: text, fontSize: fontSize, fontWeight: FontWeight.w500),
            child: child,
          ),
          if (removable) ...[
