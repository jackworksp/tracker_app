    ...
    return (
        <div className="tasks-container fade-in-up">
            <div className="glass-card">
                <div className="card-header tasks-header" style={{ marginBottom: '1.5rem', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <h1 style={{ fontSize: '2rem', margin: 0 }}>Tasks</h1>
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            {tasks.filter(t => !t.completed).map(task => (
                                ...
                                >
                                    <div 
                                        className={`task-card card-${task.type.toLowerCase()}`}
                                            ...
                                            >
                                                <div className="task-card-inner-padding">
                                                     <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                                         <div className={`task-type-badge badge-${task.type.toLowerCase() === 'task' ? 'course' : task.type.toLowerCase()}`}>
                                                            {task.type}
                                                        </div>
                                                        <button 
                                                            className="action-icon-btn delete"
                                                     ...
                                                     <div>
                                                        <h3 className="task-card-title" style={{ textDecoration: 'line-through', color: 'rgba(255,255,255,0.5)' }}>{task.title}</h3>
                                                     </div>
                            ...
                            <div className="layer-content">
                                ...
                                <div className="layer-grid">
                                    ...
                                    {selectedTask.content && (
                                        <div>
                                            <h4 className="layer-section-title">Notes</h4>
                                    ...
                                    {selectedTask.url && (
                                        <div>
                                            <h4 className="layer-section-title">Link</h4>
                                            <a 
                                    ...
                                    {/* Integrations */}
                                    <div>
                                        <h4 className="layer-section-title">Quick Actions</h4>
                                        <div className="integration-grid" style={{ marginTop: '0' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
                                        <button 
                                            ...
                                            style={{ color: '#EF4444', background: 'none', border: 'none', padding: '12px', display: 'flex', alignItems: 'center', gap: '8px', opacity: 0.8 }}
                                        >
